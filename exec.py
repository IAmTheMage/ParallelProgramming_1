...
os.system('mpicc -O3 -o mpi_vector_sum mpi_vector_sum_2.c')
...
executabl += str(size) + ' 1'
executabl_2 += str(size) + ' 1'
executabl_4 += str(size) + ' 1'
executabl_8 += str(size) + ' 1'
executabl_16 += str(size) + ' 1'
print('Default command is: {}'.format(executabl))
